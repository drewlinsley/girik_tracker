...
python mainclean.py --print-freq 20 --lr 1e-04 --epochs 2000 -b 180 --model nostride_video_cc_small --name r3d_nostride_1e-4 --log --parallel --length 32 --speed 1 --dist 14

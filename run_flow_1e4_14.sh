...
python mainclean.py --print-freq 20 --lr 1e-04 --epochs 2000 -b 56 --model nostride_video_cc_small --name nostride_video_cc_small_1e-4 --log --parallel --length 64 --speed 1 --dist 14 --optical_flow
